...
define('VERSION', $_ENV['VERSION'] ?? '1.2.2');
            ...
            <header class="header">
                ...
                <div class="header-right flex items-center gap-4">
                    ...
                    <a href="https://bycomsolutions.com" target="_blank" class="bycom-logo" style="display: flex; align-items: center; padding-left: 0.5rem; border-left: 1px solid rgba(255,255,255,0.1); margin-left: 0.5rem;">
                        <img src="http://cdn.bycomsolutions.com/logo-dark.png" style="width: 100px; height: auto; opacity: 0.8; filter: grayscale(100%); transition: all 0.3s ease;" onmouseover="this.style.opacity=1; this.style.filter='grayscale(0%)'" onmouseout="this.style.opacity=0.8; this.style.filter='grayscale(100%)'">
                    </a>
                </div>
            </header>
